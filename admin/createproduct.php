...
<form action="">
   ...
   <?php } ?>
    ...
    <input type="text" name="stock" placeholder="Enter stock" class="p-2 bg-grey-100 border rounded w-full block my-3">

    <select name="status" id="" class="p-2 bg-grey-100 border rounded w-full block my-3">
        <option value="Show">Show </option>
        <option value="Hide">Hide </option>
    </select>

    <input type="file" name="photopath" class="p-2 bg-grey-100 border rounded w-full block my-3">

    <div class="flex justify-centre gap-5 mt-5">
        <input type="submit" name="store" value="Add Product" class=" bg-blue-500 border text-white px-4 rounded cursor-pointer">
