...
<form action="actioncategory.php" method="POST">
    <input type="text" name="priority"  placeholder="Enter Priority" class="p-2 bg-gray-100 border rounded-1g w-full block my-3">

    <input type="text"  name="name"  placeholder="Enter Category Name" class="p-2 bg-gray-100 border rounded-1g w-full block my-3">
