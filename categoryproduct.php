...
$id= $_GET['category'];
$qrycat ="SELECT * FROM categories WHERE category_id =$id";

$id ="SELECT * FROM products WHERE category_id =$id ORDER BY product_date DESC";
...
?>
<h1 class="text-center fond-bold text-4xl my-10"><?php echo $rowcat['name'];?>  <span class="text-red-500"  >Products  </span>    </h1>
